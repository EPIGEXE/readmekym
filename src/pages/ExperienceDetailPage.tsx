            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 md:py-6">
                ...
                <motion.section className="mb-12 md:mb-24" variants={fadeInUp}>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-16 items-start">
                        ...
                        <div className="lg:col-span-2 space-y-4 md:space-y-8">
                            <div className="text-sm md:text-lg text-gray-500 tracking-widest uppercase" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                                Experience
                            </div>
                            ...
                            <p className="text-base md:text-xl font-light text-gray-800 leading-relaxed" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
                ...
                <motion.section variants={fadeInUp} className="mb-12 md:mb-20">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">
                        <div className="text-sm md:text-base text-gray-500 uppercase tracking-widest" style={{ fontFamily: "'Pretendard', sans-serif" }}>
                            Company
                        </div>
                        <div className="md:col-span-3">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                                <div>
                                    <h3 className="text-xs md:text-sm font-bold text-black mb-1 md:mb-2 uppercase tracking-wider">Industry</h3>
                                    <p className="text-sm md:text-base text-gray-700">{experience.company.industry}</p>
                                </div>
                                <div>
                                    <h3 className="text-xs md:text-sm font-bold text-black mb-1 md:mb-2 uppercase tracking-wider">Size</h3>
                                    <p className="text-sm md:text-base text-gray-700">{experience.company.size}</p>
                                </div>
                                <div>
                                    <h3 className="text-xs md:text-sm font-bold text-black mb-1 md:mb-2 uppercase tracking-wider">Department</h3>
                                    <p className="text-sm md:text-base text-gray-700">{experience.position.department}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <motion.section variants={fadeInUp} className="mb-12 md:mb-20">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">
                        ...
                        <div className="md:col-span-3">
                            <p className="text-sm md:text-lg leading-relaxed text-gray-700 whitespace-pre-line" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
                            ...
                            <div className="space-y-3 md:space-y-4">
                                {experience.responsibilities.map((responsibility, index) => (
                                    <div key={index} className="flex items-start gap-3 md:gap-4">
                                        ...
                                        <p className="text-sm md:text-base text-gray-700 leading-relaxed">{responsibility}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">
                        ...
                        <div className="md:col-span-3 space-y-4 md:space-y-6">
                            {experience.skills.map((skill) => (
                                <div key={skill.id} className="border-b border-gray-200 pb-3 md:pb-4 last:border-b-0">
                                    ...
                                    <p className="text-xs md:text-sm text-gray-600 leading-relaxed">{skill.usage}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                            ...
                            <div className="space-y-3 md:space-y-4">
                                {experience.achievements.map((achievement, index) => (
                                    <div key={index} className="flex items-start gap-3 md:gap-4">
                                        ...
                                        <p className="text-sm md:text-base text-gray-700 leading-relaxed">{achievement}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                                <div className="space-y-6 md:space-y-8">
                                    <div>
                                        <h3 className="text-base md:text-lg font-bold text-black mb-3 md:mb-4">What Went Well</h3>
                                        <ul className="space-y-1.5 md:space-y-2">
                                            {experience.retrospective.whatWentWell.map((item, index) => (
                                                <li key={index} className="text-xs md:text-sm text-gray-700 leading-relaxed">
                                                    {item}
                                                </li>
                                            ))}
                                        </ul>
                                    ...
                                    <div>
                                        <h3 className="text-base md:text-lg font-bold text-black mb-3 md:mb-4">Improvements</h3>
                                        <ul className="space-y-1.5 md:space-y-2">
                                ...
                                <div className="space-y-6 md:space-y-8">
                                    <div>
                                        <h3 className="text-base md:text-lg font-bold text-black mb-3 md:mb-4">Lessons Learned</h3>
                                        <ul className="space-y-1.5 md:space-y-2">
                                    ...
                                    <div>
                                        <h3 className="text-base md:text-lg font-bold text-black mb-3 md:mb-4">Career Growth</h3>
                                        <ul className="space-y-1.5 md:space-y-2">
