                                ...
                                {project.implementation.map((impl, index) => (
                                    <div key={impl.id} className="space-y-3 md:space-y-4">
                                        <div className="flex items-center gap-3 md:gap-4">
                                            ...
                                            <h3 className="text-base md:text-xl font-bold text-black">{impl.title}</h3>
                                        </div>

                                        <p className="text-sm md:text-base text-gray-700 leading-relaxed ml-8 md:ml-12">{impl.description}</p>

                                        {impl.challenges && (
                                            <div className="ml-8 md:ml-12 bg-red-50 border-l-2 md:border-l-4 border-red-200 p-3 md:p-4">
                                                <h4 className="text-xs md:text-sm font-medium text-red-800 mb-1 md:mb-2">Challenge</h4>
                                        ...
                                        {impl.solution && (
                                            <div className="ml-8 md:ml-12 bg-green-50 border-l-2 md:border-l-4 border-green-200 p-3 md:p-4">
                                                <h4 className="text-xs md:text-sm font-medium text-green-800 mb-1 md:mb-2">Solution</h4>
                        ...
                        <div className="md:col-span-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                                {project.challenges.length > 0 && (
                                    <div>
                                        <h3 className="text-base md:text-lg font-bold text-black mb-3 md:mb-4">Challenges</h3>
                                ...
                                {project.achievements.length > 0 && (
                                    <div>
                                        <h3 className="text-base md:text-lg font-bold text-black mb-3 md:mb-4">Achievements</h3>
                                        <ul className="space-y-2 md:space-y-3">
